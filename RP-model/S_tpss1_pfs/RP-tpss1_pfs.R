...
# Working diectory
path <- "C:/Users/ECHO/Desktop/nsq-cea-scope/RP-model/S_tpss1_pfs"
setwd(path)
...
num_patients <- c(192,163,190,129,144)####
...
bugs_data <- list(d=data$event, trt2=data$trt2, trt3=data$trt3, trt4=data$trt4, trt5=data$trt5, trt6=data$trt6,
                  trt2lnt=data$trt2lnt, trt3lnt=data$trt3lnt, trt4lnt=data$trt4lnt, trt5lnt=data$trt5lnt,  trt6lnt=data$trt6lnt,
...
write.csv(results, "results_tpss1_pfs.csv")
...
# Working diectory
path <- "C:/Users/ECHO/Desktop/nsq-cea-scope/RP-model/PFS_global_sub"
setwd(path)
...
num_patients <- c(492,679,578,1094,616)####
...
write.csv(results, "results_pfs_globalsub.csv")
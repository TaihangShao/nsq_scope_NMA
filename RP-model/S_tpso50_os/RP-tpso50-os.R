...
# Working diectory
path <- "C:/Users/ECHO/Desktop/nsq-cea-scope/RP-model/S_tpso50_os"
setwd(path)
...
data$trt4 <- 0
data$trt4[data$txCode==3 & data$studyCode==3] <- 1
...
write.csv(results, "results_tpso50_os.csv")
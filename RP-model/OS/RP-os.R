...
# Working diectory
path <- "C:/Users/ECHO/Desktop/nsq-cea-scope/RP-model/OS"
setwd(path)
...
num_patients <- c(412,838,492,679,578,1047,616,397,550)####
...
data$trt5 <- 0
data$trt5[data$txCode==5 & data$studyCode==4] <- 1
data$trt5[data$txCode==5 & data$studyCode==5] <- 1

data$trt6 <- 0
data$trt6[data$txCode==5 & data$studyCode==6] <- 1

data$trt7 <- 0
data$trt7[data$txCode==7] <- 1

data$trt8 <- 0
data$trt8[data$txCode==8] <- 1

data$trt9 <- 0
data$trt9[data$txCode==9] <- 1
...
bugs_data <- list(d=data$event, trt2=data$trt2, trt3=data$trt3, trt4=data$trt4, trt5=data$trt5, trt6=data$trt6, 
                  trt7=data$trt7, trt8=data$trt8, trt9=data$trt9, trt10=data$trt10,
                  ...
                  trt10lnt=data$trt10lnt, 
                  u0=data$u0, u1n=data$u1n, u2n=data$u2n, du0=data$du0,
                  du1n=data$du1n, du2n=data$du2n, Ntrials=num_studies, offset=offset,
                  k0=knots$k1[3], k1=knots$k2[3], k2=knots$k3[3], k3=knots$k4[3],
                  meanv0=df1$mean[3], sdv0=df1$sd[3], v1w0=df2$v1u0[3], w0w0=df2$u0u0[3],
                  meanw1=df3$mean[3], sdw1=df3$sd[3], v2w0=df4$v2u0[3], v2w1n=df4$v2u1n[3],
                  w1nw1n=df4$u1nu1n[3], meanw2=df5$mean[3], sdw2=df5$sd[3],
                  nt=nt)

...
# Working diectory
path <- "C:/Users/ECHO/Desktop/nsq-cea-scope/RP-model/OS_global_sub"
setwd(path)
...
num_patients <- c(838,492,679,578,1047,616)####
...
data$trt4 <- 0
data$trt4[data$txCode==4 & data$studyCode==3] <- 1
data$trt4[data$txCode==4 & data$studyCode==4] <- 1

data$trt5 <- 0
data$trt5[data$txCode==4 & data$studyCode==5] <- 1
...
write.csv(results, "results_os_globalsub.csv")